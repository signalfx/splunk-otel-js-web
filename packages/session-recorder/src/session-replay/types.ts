...
export interface SessionReplayClass extends SessionReplayClassBase {
	...
	new (config: SessionReplayConfig<SessionReplayBinarySegment>): SessionReplayInstance
}
...
export interface SessionReplayPlainClass extends SessionReplayClassBase {
	new (config: SessionReplayConfig<SessionReplayPlainSegment>): SessionReplayPlainInstance
}
...
export interface SessionReplayConfig<TSegment> {
	features?: ConfigFeatures
	logLevel?: LogLevel
	maskAllInputs?: boolean
	maskAllText?: boolean
	maxExportIntervalMs?: number
	onSegment: (segment: TSegment) => void
}
