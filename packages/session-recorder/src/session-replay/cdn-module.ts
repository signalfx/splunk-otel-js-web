...
export {
	...
	Stats,
} from 'https://cdn.signalfx.com/o11y-gdi-rum/session-replay/v2.5.4/session-replay.module.legacy.min.js'
import 'https://cdn.signalfx.com/o11y-gdi-rum/session-replay/v2.5.4/background-service.html'
