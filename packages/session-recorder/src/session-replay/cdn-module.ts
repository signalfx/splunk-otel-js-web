...
export {
	...
	type Stats,
} from 'https://cdn.observability.splunkcloud.com/o11y-gdi-rum/session-replay/v2.18.0/session-replay.module.legacy.min.js'
import 'https://cdn.observability.splunkcloud.com/o11y-gdi-rum/session-replay/v2.18.0/background-service.html'
