...
export {
	...
	type Stats,
} from 'https://cdn.observability.splunkcloud.com/o11y-gdi-rum/session-replay/v2.17.1/session-replay.module.legacy.min.js'
import 'https://cdn.observability.splunkcloud.com/o11y-gdi-rum/session-replay/v2.17.1/background-service.html'
