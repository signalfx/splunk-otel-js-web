...
export {
	...
	type Stats,
} from 'https://cdn.signalfx.com/o11y-gdi-rum/session-replay/v2.9.3/session-replay.module.legacy.min.js'
import 'https://cdn.signalfx.com/o11y-gdi-rum/session-replay/v2.9.3/background-service.html'
