...
export {
	...
	Stats,
} from 'https://cdn.signalfx.com/o11y-gdi-rum/session-replay/v2.7.0/session-replay.module.legacy.min.js'
import 'https://cdn.signalfx.com/o11y-gdi-rum/session-replay/v2.7.0/background-service.html'
