...
export {
	...
	Stats,
} from 'https://cdn.signalfx.com/o11y-gdi-rum/session-replay/v2.6.1/session-replay.module.legacy.min.js'
import 'https://cdn.signalfx.com/o11y-gdi-rum/session-replay/v2.6.1/background-service.html'
