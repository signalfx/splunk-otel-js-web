...
| `disableResourceLoadErrorReporting`   | `boolean`                                             | ❌       | `false`                                                                                                   | Suppress client-error spans for resource-element load failures. Resource timing spans and available HTTP status information continue to be reported.                                                                                                                                                                                                                      |
...
| **Instrumentations**                  |                                                       |          |                                                                                                           |                                                                                                                                                                                                                                                                                                                                                                           |
| `instrumentations.blockingElement`    | `boolean\|Config`                                     | ❌       | `false` (`true` if `navigationMetrics.monitors` includes `elements` and `blockingSelectors` is non-empty) | Per-element blocking spans for elements matching `navigationMetrics.blockingSelectors`. `enabled` overrides the navigationMetrics-derived default, and there is no separate selector config. See [Navigation Metrics](#navigation-metrics) below.                                                                                                                         |
