...
| **Instrumentations**                  |                                                       |          |                                                                                                           |                                                                                                                                                                                                                                                                                                                                                                         |
| `instrumentations.blockingElement`    | `boolean\|Config`                                     | ❌       | `false` (`true` if `navigationMetrics.monitors` includes `elements` and `blockingSelectors` is non-empty) | Per-element blocking spans for elements matching `navigationMetrics.blockingSelectors`. `enabled` overrides the navigationMetrics-derived default; there is no separate selector config. See [Navigation Metrics](#navigation-metrics) below.                                                                                                                           |
