...
The `loaf` instrumentation reports browser Long Animation Frames as `long-animation-frame` spans. It is opt-in because browser support is currently Chromium-only.
