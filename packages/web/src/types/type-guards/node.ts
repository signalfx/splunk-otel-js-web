...
export const isTextAreaElement = (node: Node): node is HTMLTextAreaElement => node.nodeName === 'TEXTAREA'

export type TextInputElement = HTMLInputElement | HTMLTextAreaElement

export const isTextInputElement = (
	maybeTextInputElement: Node,
): maybeTextInputElement is HTMLInputElement | HTMLTextAreaElement =>
	isInputElement(maybeTextInputElement) || isTextAreaElement(maybeTextInputElement)
