...
import { PrivacyManager, PrivacyManagerConfig } from './privacy/privacy-manager'
...
> extends InstrumentationBase<T> {
	...
	constructor(config: T, otelConfig: SplunkOtelWebConfig) {
		...
		let privacy: PrivacyManagerConfig = {
			maskAllInputs: true,
			maskAllText: true,
			sensitivityRules: [],
		...
		if (typeof otelConfig.instrumentations?.interactions === 'object') {
			privacy = {
				...privacy,
				...otelConfig.instrumentations.interactions.privacy,
			}
		}
