...
import { CustomTreeWalker } from './custom-tree-walker'
...
export function* traverseDFS(
	...
	const { recoverOnNotConnectedNodes, shouldProcessNode, useNativeTreeWalker } = params
	...
	const treeWalkerFactory = useNativeTreeWalker ? document : CustomTreeWalker

	const treeWalker = treeWalkerFactory.createTreeWalker(root, NodeFilter.SHOW_ALL, {
