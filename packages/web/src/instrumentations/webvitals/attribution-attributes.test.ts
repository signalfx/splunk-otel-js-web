	...
	describe('setINPAttributionAttributes', () => {
		it('emits INP attribution attributes including target and longest script fields', () => {
			...
			expect(attributes).toEqual({
				...
				'inp.longest_script.duration': 50,
				'inp.longest_script.execution_start': 105,
				'inp.longest_script.invoker': 'https://example.com/app.js?secret=1#hash',
				'inp.longest_script.invoker_type': 'event-listener',
				'inp.longest_script.pause_duration': 3,
				'inp.longest_script.source_char_position': 42,
				'inp.longest_script.source_function_name': 'clickHandler',
				'inp.longest_script.source_url': 'https://example.com/chunk.js?secret=1#hash',
				'inp.longest_script.start_time': 110,
				'inp.longest_script.window_attribution': 'self',
		...
		attribution: {
			...
			longestScript: {
				entry: {
					...
					invoker: 'https://example.com/app.js?secret=1#hash',
					invokerType: 'event-listener',
					name: 'script',
					pauseDuration: 3,
					sourceCharPosition: 42,
					sourceFunctionName: 'clickHandler',
					sourceURL: 'https://example.com/chunk.js?secret=1#hash',
					startTime: 110,
					toJSON: () => ({}),
